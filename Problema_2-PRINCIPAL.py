"""
2. (3 ptos) Crear un programa para gestionar un fichero con diferentes tipos de operaciones numéricas.
Reglas:
- El programa tendrá la función de crear el fichero con el nombre “notas.txt” crearlo si no existe y el cual será dividido en dos archivos, uno principal
...
agenda_existe = input("Desea abrir una agenda existente?(si= abrir, no: crear) : ")
rutaArchivo = "my_files/notas.txt"
if agenda_existe == "si":
    agen = open(rutaArchivo, "r")
    agen.close()
else:
    agen = open(rutaArchivo, "a+")
    agen.close()
